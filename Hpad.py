...
main_application.geometry("1536x960")
main_application.title("Hpad Text Editor")
...
file_ = tk.Menu(main_menu, tearoff=False)
...
color_dict = {
    ...
    "dark": ("#feffea", "#424242"),
    "red": ("#372248", "#ed9c96"),
    "night blue": ("#e4dfda", "#02133b")
}

# cascading #

main_menu.add_cascade(label="File", menu=file_)
...
# file #
file_.add_command(label="New", image=new_icon,
                  compound=tk.LEFT, accelerator="Ctrl+N", command=new_file)
file_.add_command(label="Open", image=open_icon,
                  compound=tk.LEFT, accelerator="Ctrl+O", command=open_file)
file_.add_command(label="Save", image=save_icon,
                  compound=tk.LEFT, accelerator="Ctrl+S", command=save_file)
file_.add_command(label="Save As", image=save_as_icon,
                  compound=tk.LEFT, accelerator="Ctrl+Alt+S", command=save_as)
file_.add_command(label="Exit", image=exit_icon,
...
def find_func(event=None):
    ...
    find_dialogue.geometry("500x190+500+100")
